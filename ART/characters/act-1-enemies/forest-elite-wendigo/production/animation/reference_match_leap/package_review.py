...
OUT=HERE.parents[1]/'review'/'animation_reference_leap'
...
selected=[0,12,18,42,45,48,51,54,59,63,78,96]
...
for directory,pattern,target in [(FRAMES,'pair_%04d.png',f'leap_comparison{suffix}.mp4'),(HERE/'frames','pose_%04d.png',f'leap_3d{suffix}.mp4')]:
...
(OUT/'review_status.json').write_text(json.dumps({'status':'working_reference_study_not_approved','revision':args.revision or 'r01','unity_import_allowed':False,'frames':97,'fps':24,'motion':'Leap only','source':'../../../review/higgsfield-refs/leap.mp4','scene':'../../animation/reference_match_leap/Leap_Reference_Spline.blend','remaining_review':'Owner comparison of motion; no claim of exact match or finished animation pack.'},indent=2))
print(OUT)
