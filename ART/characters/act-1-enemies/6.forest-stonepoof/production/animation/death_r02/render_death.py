...
p=Path(__file__).parent;out=p.parents[1]/'review'/'animation_death_r02';bpy.ops.wm.open_mainfile(filepath=str(p/'Stonehoof_Death_r02.blend'));s=bpy.context.scene;cam=s.camera
