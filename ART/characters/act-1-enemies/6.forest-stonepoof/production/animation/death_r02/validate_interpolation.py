...
times=sorted(set([i/32 for i in range(1921)]+[60-.001,.001]))
def sample(file):
 ...
 return out
source=sample('Stonehoof_Death_r02.blend');baked=sample('Stonehoof_Death_Baked_r02.blend')
...
endpoint=max((baked[60][n].translation-source[60][n].translation).length for n in baked[60])
