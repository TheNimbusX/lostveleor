...
bpy.ops.wm.open_mainfile(filepath=str(HERE/'Stonehoof_Death_r01.blend'))
...
scene.frame_set(0);bpy.ops.wm.save_as_mainfile(filepath=str(HERE/'Stonehoof_Death_Baked_r01.blend'))
