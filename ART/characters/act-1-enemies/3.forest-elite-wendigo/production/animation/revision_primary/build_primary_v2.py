...
OUT = HERE / "Wendigo_Primary_v3_Skin.blend"
...
CLAW = {
    ...
    7: dict(pz=-.09, py=-.07, hip_yaw=12, chest_yaw=13,
            ...
            lfoot_z=.065, rfoot_x=.05, rfoot_y=-.16,
            rfoot_z=.06, lclav_yaw=9),
    ...
    15: dict(pz=-.15, py=-.08, hip_yaw=20, chest_yaw=34,
    ...
    16: dict(pz=-.15, py=-.01, hip_yaw=15, chest_yaw=29,
             chest_pitch=-13, head_yaw=-10, head_pitch=2,
             lhand_x=-.45, lhand_y=-.06, lhand_z=.84,
    ...
    17: dict(pz=-.25, py=.10, hip_yaw=0, chest_yaw=0,
             ...
             lhand_x=.26, lhand_y=.66, lhand_z=.38,
    ...
    18: dict(pz=-.36, py=.18, hip_yaw=-15, chest_yaw=-31,
             ...
             head_pitch=22, lhand_x=.98, lhand_y=.24,
             lhand_z=-.61, rhand_x=-.35, rhand_y=-.04,
    ...
    19: dict(pz=-.42, py=.20, hip_yaw=-27, chest_yaw=-51,
             ...
             head_pitch=20, lhand_x=1.03, lhand_y=.34,
             lhand_z=-.65, rhand_x=-.38, rhand_y=-.05,
    ...
    21: dict(pz=-.35, py=.17, hip_yaw=-23, chest_yaw=-49,
             ...
             head_pitch=16, lhand_x=.93, lhand_y=.29,
             lhand_z=-.59, rhand_x=-.30, rhand_y=0,
    ...
    24: dict(pz=-.23, py=.10, hip_yaw=-15, chest_yaw=-25,
             ...
             lhand_x=.66, lhand_y=.30, lhand_z=-.45,
...
LEAP = {
    ...
    12: dict(pz=-.31, py=-.07, chest_pitch=-27,
             ...
             rclav_yaw=45, rclav_pitch=22),
    18: dict(pz=-.52, py=0, chest_pitch=-43,
             head_pitch=16, lhand_x=-.47, lhand_y=.04,
             lhand_z=-.36, rhand_x=.44, rhand_y=1.26,
             rhand_z=-.63, lclav_pitch=-12,
             rclav_yaw=60, rclav_pitch=30),
    23: dict(pz=-.57, py=.04, chest_pitch=-49,
             head_pitch=20, lhand_x=-.47, lhand_y=.04,
             lhand_z=-.36, rhand_x=.44, rhand_y=1.26,
             rhand_z=-.63, lclav_pitch=-14,
             rclav_yaw=60, rclav_pitch=30,
             lfoot_y=0, rfoot_y=0, lfoot_z=0, rfoot_z=0),
    24: dict(pz=-.18, py=.12, chest_pitch=-30,
             head_pitch=8, lhand_x=-.43, lhand_y=.13,
    ...
    26: dict(pz=.42, py=.18, chest_pitch=-15,
             head_pitch=-5, lhand_x=-.27, lhand_y=.30,
             lhand_z=.52, rhand_x=.29, rhand_y=1.38,
             rhand_z=.52, lfoot_y=-.15, lfoot_z=.26,
             rfoot_y=.10, rfoot_z=.24, lclav_pitch=4,
             rclav_yaw=48, rclav_pitch=22),
    28: dict(pz=.73, py=.23, chest_pitch=-14,
             head_pitch=-13, lhand_x=-.37, lhand_y=.27,
             lhand_z=.83, rhand_x=.39, rhand_y=1.45,
             rhand_z=.83, lfoot_y=-.20, lfoot_z=.52,
             rfoot_y=.15, rfoot_z=.48, lclav_pitch=8,
             rclav_yaw=43, rclav_pitch=18),
    30: dict(pz=.55, py=.26, chest_pitch=-26,
             head_pitch=-4, lhand_x=-.37, lhand_y=.27,
             lhand_z=.65, rhand_x=.39, rhand_y=1.45,
             rhand_z=.65, lfoot_y=-.16, lfoot_z=.36,
             rfoot_y=.12, rfoot_z=.34, lclav_pitch=3,
             rclav_yaw=47, rclav_pitch=20),
    31: dict(pz=.29, py=.25, chest_pitch=-37,
             head_pitch=3, lhand_x=-.43, lhand_y=.20,
             lhand_z=.24, rhand_x=.42, rhand_y=1.37,
             rhand_z=.28, lfoot_y=-.07, lfoot_z=.18,
             rfoot_y=.06, rfoot_z=.17,
             rclav_yaw=53, rclav_pitch=23),
    32: dict(pz=-.04, py=.23, chest_pitch=-46,
             head_pitch=10, lhand_x=-.47, lhand_y=.08,
             lhand_z=-.26, rhand_x=.44, rhand_y=1.28,
             rhand_z=-.36, lfoot_z=.04, rfoot_z=.04,
             rclav_yaw=58, rclav_pitch=27),
    33: dict(pz=-.47, py=.19, chest_pitch=-49,
             head_pitch=24, lhand_x=-.47, lhand_y=.04,
             lhand_z=-.36, rhand_x=.44, rhand_y=1.26,
             rhand_z=-.63, lfoot_y=0, rfoot_y=0,
             lfoot_z=0, rfoot_z=0,
             lclav_pitch=-4, rclav_yaw=60, rclav_pitch=30),
    35: dict(pz=-.55, py=.19, chest_pitch=-57,
             head_pitch=32, lhand_x=-.47, lhand_y=.04,
             lhand_z=-.36, rhand_x=.44, rhand_y=1.26,
             rhand_z=-.63, lclav_pitch=-11,
             rclav_yaw=60, rclav_pitch=30),
    38: dict(pz=-.47, py=.16, chest_pitch=-49,
             head_pitch=21, lhand_x=-.47, lhand_y=.04,
             lhand_z=-.36, rhand_x=.44, rhand_y=1.26,
             rhand_z=-.63, lclav_pitch=-9,
             rclav_yaw=60, rclav_pitch=30),
