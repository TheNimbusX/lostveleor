...
{
    /// <summary>
    /// Главное меню М1 «Трещина» на фоне «Дым» с живым швом разлома (владелец, 25–26 сентября; вид
    /// строит MainMenuWcBuilder, шов живёт в MainMenuRift). Слева лого, «Продолжить» со строкой о
    /// сохранении, «Новая игра», «Настройки», «Выход»; «Новая игра» спрашивает подтверждение (окно
    /// «Дыма и света»).
