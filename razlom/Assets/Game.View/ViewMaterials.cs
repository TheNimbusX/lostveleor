...
namespace Game.View
{
    ...
    public static class ViewMaterials
    {
        ...
        ///
        /// ТЕНЬ СВЕТЛАЯ И ПОЧТИ НЕЙТРАЛЬНАЯ.
        ///
        ...
        ///
        /// Почти нейтральная — по итогам ошибки 1 сентября. Здесь стояло
        /// (0.58,0.66,0.88), и одновременно холодный оттенок задавался в
        /// шейдере, в амбиенте, в fill-свете сцены, в градиенте окружения и в
        /// Split Toning. Пять источников одного тона перемножились, и кадр
        /// ушёл в бирюзу целиком.
        ///
        /// Правило, которое из этого следует: ТОН ПРИНАДЛЕЖИТ ОСВЕЩЕНИЮ.
        /// Материал добавляет от себя лишь намёк, иначе он спорит со сценой,
        /// и настроить их вместе становится нельзя.
        /// </summary>
        public static readonly Color ToonShadow = new Color(0.72f, 0.75f, 0.84f, 1f);
